  ...
  return (
    <main className="flex flex-col min-h-screen">
      <div className="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1">
        <div className="flex flex-col text-center items-center justify-center bg-sky-900 min-h-screen p-8 md:p-20 gap-2">
          <h1 className="text-2xl font-semibold">Jellyfish</h1>
          <p>&quot;Fish up&quot; media (music, movies, tv shows, etc) from a Jellyfin server!</p>
        </div>
        <div className="flex flex-col text-center items-center justify-center min-h-screen p-8 md:p-20 gap-2">
